...
namespace MenuItemListing.Controllers
{
    ...
    public class MenuItemController : ControllerBase
    {
        ...
        public List<MenuItem> GetItem()
        {
            ...
            {   new MenuItem() {Id=1, Name="burger", Active=true, DateOfLaunch=new DateTime(2022,01,01), FreeDelivery=false,Price=120},
                new MenuItem() {Id=2, Name="Pizza", Active=false, DateOfLaunch=new DateTime(2022,10,03), FreeDelivery=false,Price=1200}
